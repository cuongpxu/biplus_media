...
class MainActivity: FlutterActivity() {
    ...
    override fun configureFlutterEngine(@NonNull flutterEngine: FlutterEngine) {
        ...
        MethodChannel(flutterEngine.dartExecutor.binaryMessenger, "com.biplus.media/sharedTextChannel")
        ...
        MethodChannel(flutterEngine.dartExecutor.binaryMessenger, "com.biplus.media/registerMedia")
        ...
        MethodChannel(flutterEngine.dartExecutor.binaryMessenger, "com.biplus.media/intentChannel")
                .setMethodCallHandler { call: MethodCall, result: MethodChannel.Result ->
