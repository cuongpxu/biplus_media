...
import 'biplus_media_theme.dart';

class AppTheme {
  static BiplusMediaTheme get currentTheme => GetIt.I<BiplusMediaTheme>();
  static ThemeMode get themeMode => GetIt.I<BiplusMediaTheme>().currentTheme();
