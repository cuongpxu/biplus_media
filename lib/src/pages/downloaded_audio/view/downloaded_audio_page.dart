...
import 'package:biplus_media/src/helpers/audio_query.dart';
import 'package:biplus_media/src/pages/audio_playing/view/audio_playing_page.dart';
import 'package:biplus_media/src/pages/downloaded_audio/widgets/local_playlists.dart';
...
class DownloadedAudioPage extends StatefulWidget {
  ...
  @override
  _DownloadedAudioPageState createState() => _DownloadedAudioPageState();
}
...
class _DownloadedAudioPageState extends State<DownloadedAudioPage>
  ...
  @override
  void initState() {
    print('Tab controller: ${widget.showPlaylists}');
    _tcontroller =
        TabController(length: widget.showPlaylists ? 2 : 1, vsync: this);
    getData();
    super.initState();
  }
        ...
        children: [
          Expanded(
            child: DefaultTabController(
              length: widget.showPlaylists ? 2 : 1,
              child: Scaffold(
...
class _SongsTabState extends State<SongsTab>
  ...
  Widget build(BuildContext context) {
    ...
    return widget.songs.isEmpty
        ? emptyScreen(
      context, 3,
      AppLocalizations.of(context)!.nothingTo, 15.0,
      AppLocalizations.of(context)!.showHere, 45,
      AppLocalizations.of(context)!.downloadSomething, 23.0
    )
        : Column(
      children: [
        PlaylistHead(
        ...
        return ListTile(
          ...
          onTap: () {
            Navigator.push(
              context,
              MaterialPageRoute(
                builder: (context) => DownloadedAudioPage(
