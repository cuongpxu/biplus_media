...
class FavoriteAudioListingPage extends StatefulWidget {
  final List data;
  final bool offline;
  final String? title;
  const FavoriteAudioListingPage({
    Key? key,
    required this.data,
  ...
  @override
  _FavoriteAudioListingPageState createState() => _FavoriteAudioListingPageState();
}

class _FavoriteAudioListingPageState extends State<FavoriteAudioListingPage> {
  List _songs = [];
  List original = [];
  bool offline = false;
  bool added = false;
