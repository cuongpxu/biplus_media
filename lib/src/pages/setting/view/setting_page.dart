...
import 'package:biplus_media/src/configs/country_codes.dart';
...
import 'package:biplus_media/src/pages/top_chart/view/top_chart_page.dart' as top_screen;
...
import 'package:biplus_media/src/pages/home/view/home_page.dart' as home_screen;
          ...
          SliverList(
            delegate: SliverChildListDelegate(
              [
                                              ...
                                              GestureDetector(
                                                ...
                                                child: Container(
                                                  ...
                                                  decoration: BoxDecoration(
                                                    ...
                                                    color: BiplusMediaTheme().getColor(
                                                      colors[index],
                                                      hue,
                                                    ),
                                                    boxShadow: [
                ...
                //             onPressed: () async {
                //               downloadPath =
                //                   await ExternalStorageProvider.getExtStorage(
                //                     dirName: 'Music',
                //                   ) ??
                        ...
                        ListTile(
                          ...
                          onTap: () {
                            Share.share(
                              '${AppLocalizations.of(
                                context,
                              )!.shareAppText}: https://biplus.com.vn',
                            );
                          },
                          dense: true,
                        ),
                                          ...
                                          children: [
                                            IconButton(
                                              ...
                                              onPressed: () {
                                                Navigator.pop(context);
                                                launch(
                                                  'https://mail.google.com/mail/?extsrc=mailto&url=mailto%3A%3Fto%3Dmedia%40biplus.com.vn%26subject%3DRegarding%2520Biplus%2520Media%2520App',
                                                );
                                              },
                                            ),
                                            Text(
