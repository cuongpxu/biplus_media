...
import 'package:biplus_media/src/api/spotify_api.dart';
import 'package:biplus_media/src/helpers/playlist_helper.dart';
import 'package:biplus_media/src/helpers/search_add_playlist.dart';
import 'package:biplus_media/src/pages/favorite/view/favorite_page.dart';
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    ListTile(
                      ...
                      onTap: () async {
                        playlistNames =
                        await PlaylistHelper().importPlaylist(context, playlistNames);
                        settingsBox.put('playlistNames', playlistNames);
                        setState(() {});
                      },
                    ),
                        ...
                        Stream<Map> songsAdder() async* {
                          ...
                          for (final track in tracks) {
                            ...
                            try {
                              ...
                              PlaylistHelper().addMapToPlaylist(
                                playName,
                                result[0] as Map,
                              );
                            } catch (e) {
      ...
      Stream<Map> songsAdder() async* {
        ...
        for (final track in tracks) {
          ...
          try {
            ...
            PlaylistHelper().addMapToPlaylist(playName, result[0] as Map);
          } catch (e) {
            // print('Error in $_done: $e');
          }
        }
