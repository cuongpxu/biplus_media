...
import 'package:biplus_media/src/helpers/backup_restore.dart';
import 'package:biplus_media/src/helpers/supabase.dart';
import 'package:biplus_media/src/pages/auth/login/login.dart';
import 'package:biplus_media/src/pages/downloaded_audio/view/downloaded_audio_page.dart';
import 'package:biplus_media/src/pages/home/view/home_body.dart';
import 'package:biplus_media/src/pages/profile/profile.dart';
import 'package:biplus_media/src/pages/search/view/search_page.dart';
import 'package:biplus_media/src/pages/setting/view/setting_page.dart';
import 'package:biplus_media/src/providers/external_storage_provider.dart';
    ...
    if (!checked && Theme.of(context).platform == TargetPlatform.android) {
      ...
      PackageInfo.fromPlatform().then((PackageInfo packageInfo) {
        ...
        if (autoBackup) {
          ...
          ExternalStorageProvider.getExtStorage(dirName: 'BiPlusMedia/Backups')
              .then((value) {
            createBackup(
              context,
              checked,
              boxNames,
              path: value,
              fileName: 'BiPlusMedia_AutoBackup',
              showDialog: false,
            );
          });
        }
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<AppBloc, AppState>(builder: (context, state) {
      return Scaffold(
        ...
        backgroundColor:
            AppTheme.themeMode == ThemeMode.dark ? Colors.black : Colors.white,
        drawer: Drawer(
                    ...
                    [
                        ...
                        ListTile(
                          ...
                          onTap: () {
                            ...
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => const DownloadedAudioPage(
                                  showPlaylists: false,
                                ),
                              ),
                            );
                      ...
                      if (state.status == AppStatus.authenticated)
                        ListTile(
                          ...
                          onTap: () {
                            context.read<AppBloc>().add(const AppLogoutRequested(User.empty));
                            Navigator.pop(context);
